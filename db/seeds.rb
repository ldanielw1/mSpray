...
create_spray_datum({:timestamp=>"2018-09-06 15:24:55", :imei=>"358240051111110", :lat=>"-23.35287975", :lng=>"29.44401074", :gps_accuracy=>"20", :is_mopup_spray=>"FALSE", :foreman=>"Daniel", :chemical_used=>"K-Orthrine", :unsprayed_rooms=>1, :unsprayed_shelters=>11, :stats=>{"2"=>{:rooms_sprayed=>"22", :shelters_sprayed=>"1", :refilled=>"false"}}})
create_spray_datum({:timestamp=>"2018-09-06 15:29:05", :imei=>"358240051111110", :lat=>"-23.151", :lng=>"30.4437666", :gps_accuracy=>"20", :is_mopup_spray=>"FALSE", :foreman=>"Jane", :chemical_used=>"N/A", :unsprayed_rooms=>3, :unsprayed_shelters=>0, :stats=>{"3"=>{:rooms_sprayed=>"0", :shelters_sprayed=>"0", :refilled=>"false"}}})
